...
DROP FUNCTION IF EXISTS cms.post_history_function;

CREATE OR REPLACE FUNCTION cms.post_history_function() RETURNS TRIGGER AS
$post_history_table$
BEGIN
...
CREATE TRIGGER post_history_trigger
    ...
    ON cms.post
    FOR EACH ROW
EXECUTE PROCEDURE cms.post_history_function();
